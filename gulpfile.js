...
//    var command = "zowe endevor generate element " + config.testElement + " --type COBOL --override-signout --maxrc 0 --stage-number 1";
//var command = "zowe  endevor update element FINARP05 --env SMPLTEST --sys --sub ACCTPAY --typ COBOL --ff DFH0XVDS.cbl -i ENDEVOR --comment test9 --ccid abcd9";
...
gulp.task("build-lnk", function(callback) {
  ...
  var command =
    "zowe endevor generate element DFH0XVDS --env SMPLTEST --sn 1 --sys MARBLES --sub MARBLES --type LNK --cb -i ENDEVOR --comment ysk2 --ccid ysk2 --os";
